...
<div class="@container overflow-y-auto">
  <div class="relative flex h-full flex-col px-12 @min-[48rem]:px-32">
    <!-- Block menu -->
    {#if $editor}
      <div
        class="sticky top-0 z-10 flex items-center gap-1 bg-linear-to-b from-white via-white via-80% to-transparent pt-8 pb-12"
      >
